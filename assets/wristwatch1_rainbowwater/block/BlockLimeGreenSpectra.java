...
public class BlockLimeGreenSpectra extends BlockFluidClassic 
{
	...
	public BlockLimeGreenSpectra(int Id) 
	{
		super(Id, rainbowwater.LimeGreenSpectra, Material.water);
		rainbowwater.LimeGreenSpectra.setBlockID(2366); // Sets the fluids block ID to this block.
