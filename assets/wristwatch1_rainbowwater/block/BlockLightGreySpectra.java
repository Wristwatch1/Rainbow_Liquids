...
public class BlockLightGreySpectra extends BlockFluidClassic 
{
	...
	public BlockLightGreySpectra(int Id) 
	{
		super(Id, rainbowwater.LightGreySpectra, Material.water);
		rainbowwater.LightGreySpectra.setBlockID(2364); // Sets the fluids block ID to this block.
