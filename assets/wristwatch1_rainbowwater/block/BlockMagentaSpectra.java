...
public class BlockMagentaSpectra extends BlockFluidClassic 
{
	...
	public BlockMagentaSpectra(int Id) 
	{
		super(Id, rainbowwater.MagentaSpectra, Material.water);
		rainbowwater.MagentaSpectra.setBlockID(2368); // Sets the fluids block ID to this block.
