...
public class BlockYellowSpectra extends BlockFluidClassic 
{
	...
	public BlockYellowSpectra(int Id) 
	{
		super(Id, rainbowwater.YellowSpectra, Material.water);
		rainbowwater.YellowSpectra.setBlockID(2380); // Sets the fluids block ID to this block.
