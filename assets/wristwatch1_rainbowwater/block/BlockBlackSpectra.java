...
public class BlockBlackSpectra extends BlockFluidClassic 
{
	...
	public BlockBlackSpectra(int Id) 
	{
		super(Id, rainbowwater.BlackSpectra, Material.water);
		rainbowwater.BlackSpectra.setBlockID(2350); // Sets the fluids block ID to this block.
