...
public class CyanSpectraBucketHandler 
{
	...
	public ItemStack attemptFill( World world, MovingObjectPosition p )
	{
		...
		if ( id == rainbowwater.BlockCyanSpectra.blockID ) //if the liquid is this liquid
		{
			if ( world.getBlockMetadata( p.blockX, p.blockY, p.blockZ ) == 0 ) // Check that it is a source block
				...
				return new ItemStack( rainbowwater.CyanSpectraBucket ); // Return the filled bucked item here.
				}
		}
		return null;
