...
public class LightGreySpectraBucketHandler 
{
	...
	public ItemStack attemptFill( World world, MovingObjectPosition p )
	{
		...
		if ( id == rainbowwater.BlockLightGreySpectra.blockID ) //if the liquid is this liquid
		{
			if ( world.getBlockMetadata( p.blockX, p.blockY, p.blockZ ) == 0 ) // Check that it is a source block
				...
				return new ItemStack( rainbowwater.LightGreySpectraBucket ); // Return the filled bucked item here.
				}
		}
		return null;
