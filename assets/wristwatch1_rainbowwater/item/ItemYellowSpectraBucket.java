...
public class ItemYellowSpectraBucket extends ItemBucket
	{
	 public ItemYellowSpectraBucket(int id, int liquidID) 
	 {
	  super(id, liquidID);
	 ...
	 
	 {
	     ...
	     this.itemIcon = par1IconRegister.registerIcon("wristwatch1_rainbowwater:ItemYellowSpectraBucket");//registers the texture.
