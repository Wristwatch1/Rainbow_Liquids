...
public class ItemOrangeSpectraBucket extends ItemBucket
	{
	 public ItemOrangeSpectraBucket(int id, int liquidID) 
	 {
	  super(id, liquidID);
	 ...
	 
	 {
	     ...
	     this.itemIcon = par1IconRegister.registerIcon("wristwatch1_rainbowwater:ItemOrangeSpectraBucket");//registers the texture.
