...
public class ItemCyanSpectraBucket extends ItemBucket
	{
	 public ItemCyanSpectraBucket(int id, int liquidID) 
	 {
	  super(id, liquidID);
	 ...
	 
	 {
	     ...
	     this.itemIcon = par1IconRegister.registerIcon("wristwatch1_rainbowwater:ItemCyanSpectraBucket");//registers the texture.
