...
public class ItemGreenSpectraBucket extends ItemBucket
	{
	 public ItemGreenSpectraBucket(int id, int liquidID) 
	 {
	  super(id, liquidID);
	 ...
	 
	 {
	     ...
	     this.itemIcon = par1IconRegister.registerIcon("wristwatch1_rainbowwater:ItemGreenSpectraBucket");//registers the texture.
