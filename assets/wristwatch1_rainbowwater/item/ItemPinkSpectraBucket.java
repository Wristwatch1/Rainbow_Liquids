...
public class ItemPinkSpectraBucket extends ItemBucket
	{
	 public ItemPinkSpectraBucket(int id, int liquidID) 
	 {
	  super(id, liquidID);
	 ...
	 
	 {
	     ...
	     this.itemIcon = par1IconRegister.registerIcon("wristwatch1_rainbowwater:ItemPinkSpectraBucket");//registers the texture.
