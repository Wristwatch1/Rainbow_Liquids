...
public class ItemRedSpectraBucket extends ItemBucket
	{
	 public ItemRedSpectraBucket(int id, int liquidID) 
	 {
	  super(id, liquidID);
	 ...
	 
	 {
	     ...
	     this.itemIcon = par1IconRegister.registerIcon("wristwatch1_rainbowwater:ItemRedSpectraBucket");//registers the texture.
