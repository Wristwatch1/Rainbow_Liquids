...
public class ItemLightBlueSpectraBucket extends ItemBucket
	{
	 public ItemLightBlueSpectraBucket(int id, int liquidID) 
	 {
	  super(id, liquidID);
	 ...
	 
	 {
	     ...
	     this.itemIcon = par1IconRegister.registerIcon("wristwatch1_rainbowwater:ItemLightBlueSpectraBucket");//registers the texture.
