...
public class ItemLimeGreenSpectraBucket extends ItemBucket
	{
	 public ItemLimeGreenSpectraBucket(int id, int liquidID) 
	 {
	  super(id, liquidID);
	 ...
	 
	 {
	     ...
	     this.itemIcon = par1IconRegister.registerIcon("wristwatch1_rainbowwater:ItemLimeGreenSpectraBucket");//registers the texture.
