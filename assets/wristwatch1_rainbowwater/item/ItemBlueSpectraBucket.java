...
public class ItemBlueSpectraBucket extends ItemBucket
	{
	 public ItemBlueSpectraBucket(int id, int liquidID) 
	 {
	  super(id, liquidID);
	 ...
	 
	 {
	     ...
	     this.itemIcon = par1IconRegister.registerIcon("wristwatch1_rainbowwater:ItemBlueSpectraBucket");//registers the texture.
