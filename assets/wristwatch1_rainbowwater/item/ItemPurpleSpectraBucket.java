...
public class ItemPurpleSpectraBucket extends ItemBucket
	{
	 public ItemPurpleSpectraBucket(int id, int liquidID) 
	 {
	  super(id, liquidID);
	 ...
	 
	 {
	     ...
	     this.itemIcon = par1IconRegister.registerIcon("wristwatch1_rainbowwater:ItemPurpleSpectraBucket");//registers the texture.
