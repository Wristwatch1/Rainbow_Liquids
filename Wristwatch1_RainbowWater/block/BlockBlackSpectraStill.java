...
public class BlockBlackSpectraStill extends BlockStationary
{
	public BlockBlackSpectraStill(int id, Material par2Material) 
	{
	  ...
	  @Override
		...
		public void onEntityCollidedWithBlock(World world, int i, int j, int k, Entity entity)
		{
			...
			{         
				((EntityLiving) entity).addPotionEffect(new PotionEffect(Potion.harm.getId(),2 * 20, 0));
				}  
			{
