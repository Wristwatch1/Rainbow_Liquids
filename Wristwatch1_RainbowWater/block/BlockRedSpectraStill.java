...
public class BlockRedSpectraStill extends BlockStationary
{
	public BlockRedSpectraStill(int id, Material par2Material) 
	{
	  ...
	  @Override
		...
		public void onEntityCollidedWithBlock(World world, int i, int j, int k, Entity entity)
		{
			...
			{         
				((EntityLiving) entity).addPotionEffect(new PotionEffect(Potion.fireResistance.getId(),1200, 1));
				}  
			{
