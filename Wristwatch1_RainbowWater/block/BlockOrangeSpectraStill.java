...
public class BlockOrangeSpectraStill extends BlockStationary
{
	public BlockOrangeSpectraStill(int id, Material par2Material) 
	{
	  ...
	  @Override
		...
		public void onEntityCollidedWithBlock(World world, int i, int j, int k, Entity entity)
		{
			...
			{         
				((EntityLiving) entity).addPotionEffect(new PotionEffect(Potion.damageBoost.getId(),1200, 1));
				}  
			{
