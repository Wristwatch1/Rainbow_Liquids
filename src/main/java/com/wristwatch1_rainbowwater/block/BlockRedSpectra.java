...
public class BlockRedSpectra extends BlockFluidClassic 
{
		    ...
		    public BlockRedSpectra(Fluid fluid, Material material) {
		            super(fluid, material);
		            setBlockName("RedSpectra");
		            setLightLevel(1.0f);
		            try {
		              coloredlightscore.src.api.CLApi.setBlockColorRGB(this, 15, 0, 0);
		            } catch (Throwable e) {
		    ...
		    public void registerBlockIcons(IIconRegister iconregister) {
		            this.stillIcon = iconregister.registerIcon("wristwatch1_rainbowwater:BlockRedSpectraStill");
		            this.flowingIcon = iconregister.registerIcon("wristwatch1_rainbowwater:BlockRedSpectraFlowing");
		    }
		    @Override
