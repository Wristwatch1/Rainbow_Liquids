...
public class BlockOrangeSpectra extends BlockFluidClassic 
{
	 @SideOnly(Side.CLIENT)
	    ...
	    public void registerBlockIcons(IIconRegister iconregister) {
	            this.stillIcon = iconregister.registerIcon("wristwatch1_rainbowwater:BlockOrangeSpectraStill");
	            this.flowingIcon = iconregister.registerIcon("wristwatch1_rainbowwater:BlockOrangeSpectraFlowing");
	    }
	    @Override
