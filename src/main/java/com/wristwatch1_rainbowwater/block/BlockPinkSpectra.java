...
public class BlockPinkSpectra extends BlockFluidClassic 
{
    ...
    public void registerBlockIcons(IIconRegister iconregister) {
            this.stillIcon = iconregister.registerIcon("wristwatch1_rainbowwater:BlockPinkSpectraStill");
            this.flowingIcon = iconregister.registerIcon("wristwatch1_rainbowwater:BlockPinkSpectraFlowing");
    }
    @Override
