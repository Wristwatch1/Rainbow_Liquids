...
public class BlockLightBlueSpectra extends BlockFluidClassic 
{
    ...
    public BlockLightBlueSpectra(Fluid fluid, Material material) {
            super(fluid, material);
            setBlockName("LightBlueSpectra");
            setLightLevel(1.0f);
            try {
              coloredlightscore.src.api.CLApi.setBlockColorRGB(this, 3, 7, 15);
            } catch (Throwable e) {
    ...
    public void registerBlockIcons(IIconRegister iconregister) {
            this.stillIcon = iconregister.registerIcon("wristwatch1_rainbowwater:BlockLightBlueSpectraStill");
            this.flowingIcon = iconregister.registerIcon("wristwatch1_rainbowwater:BlockLightBlueSpectraFlowing");
    }
    @Override
