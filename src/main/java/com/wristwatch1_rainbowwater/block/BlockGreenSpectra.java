...
public class BlockGreenSpectra extends BlockFluidClassic 
{
	 ...
	 @SideOnly(Side.CLIENT)
	    ...
	    public BlockGreenSpectra(Fluid fluid, Material material) {
	    ...
	    public void registerBlockIcons(IIconRegister iconregister) {
	            this.stillIcon = iconregister.registerIcon("wristwatch1_rainbowwater:BlockGreenSpectraStill");
	            this.flowingIcon = iconregister.registerIcon("wristwatch1_rainbowwater:BlockGreenSpectraFlowing");
	    }
	    @Override
