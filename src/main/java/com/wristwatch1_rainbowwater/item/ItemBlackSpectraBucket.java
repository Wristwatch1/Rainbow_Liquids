...
public class ItemBlackSpectraBucket extends ItemBucket
	{
	 public ItemBlackSpectraBucket(Block block) 
	 {
	  super(block);
	 ...
	 
	 {
	     ...
	     this.itemIcon = par1IconRegister.registerIcon("wristwatch1_rainbowwater:ItemBlackSpectraBucket");//registers the texture.
