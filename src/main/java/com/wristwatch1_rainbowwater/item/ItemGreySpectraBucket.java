...
public class ItemGreySpectraBucket extends ItemBucket
	{
	 public ItemGreySpectraBucket(Block block) 
	 {
	  super(block);
	 ...
	 
	 {
	     ...
	     this.itemIcon = par1IconRegister.registerIcon("wristwatch1_rainbowwater:ItemGreySpectraBucket");//registers the texture.
