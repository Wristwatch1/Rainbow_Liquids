...
public class ItemWhiteSpectraBucket extends ItemBucket
	{
	 public ItemWhiteSpectraBucket(Block block) 
	 {
	  super(block);
	 ...
	 
	 {
	     ...
	     this.itemIcon = par1IconRegister.registerIcon("wristwatch1_rainbowwater:ItemWhiteSpectraBucket");//registers the texture.
